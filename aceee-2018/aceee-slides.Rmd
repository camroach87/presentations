...
Focus on air-handling unit BMS data from three separate buildings.
...
Buildings have inconsistent point descriptions. However there are often some useful acronyms hidden within the names. We engineer text features that help us to find these useful bits of information.
...
<!-- * t-SNE preserves nearest neighbours -->
