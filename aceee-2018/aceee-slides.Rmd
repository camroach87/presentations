...
* Skew
* Kurtosis
* Maximum change in value between readings
* Minimum change in value between readings
* Number of times the sensor readings cross the mean value.
...
* Similar BMS points are clustered together.
