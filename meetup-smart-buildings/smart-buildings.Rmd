...
Simple example - if high temperature readings are recorded in a room, chillers and air handling units will activate.
...
* Buildings Alive's goal is to
    ...
    + Analyse and present data in an interpretable manner.
