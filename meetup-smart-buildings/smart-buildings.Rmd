...
* Finish BMS section
* Show a plot of all the time-series overlapping (messy) and then a plot of the spectral embedding dimensionaity reduction (clean!). Maybe show clustering as well.
...
Normalise these to span the range $\left[ 0, 1\right]$ to prevent certain features dominating the clustering [@Wang2006-tz].
