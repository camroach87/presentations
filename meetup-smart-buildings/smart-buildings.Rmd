...
> - BMS systems are costly to implement and to change. Can often require large amounts of recoding to tune the BMS's behaviour.
> - The bigger the BMS is the harder it is to find what matters. Locating problems is difficult and time-consuming.
> - For example, a heating valve might be locked open. If this isn't detected the BMS will cool the room to reach required temperature.
