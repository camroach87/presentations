...
* Finish BMS section
* Show a plot of all the time-series overlayed (messy) and then a plot of the spectral embedding dimensionaity reduction (clean!). Maybe show clustering as well.
...
* Number of "zero crossings" per day
