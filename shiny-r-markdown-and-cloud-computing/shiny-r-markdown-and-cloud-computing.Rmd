...
* Improving your work-flow with Addins (Shiny gadgets).
...
R Studio makes this very easy. Simply select a new R Markdown document and select shiny.
...
* Easy to scale.
* Can host R Studio or Shiny server.
* Just wonderful.
...
2. Install R Studio Server.
3. Set up access group with correct permissions.
