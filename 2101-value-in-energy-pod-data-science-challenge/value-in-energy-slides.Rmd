...
A quick example for one of the competition forecast dates will be presented at the end.
...
Highly parameterized model! Needed to take care to avoid over-fitting. Used time series cross validation to tune **number of leaves** and **learning rate** parameters. Typically used 5 "week-long" folds and RMSE to assess accuracy, but experimented throughout.
